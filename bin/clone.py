...
def main() -> int:
    ...
    print("  3. Re-shoot home + run `python3 bin/build-theme-screenshots.py")
    print(f"        {dest.name}` so screenshot.png shows YOUR theme rendering")
    print("        (clone copied the source theme's screenshot byte-for-byte;")
    print("        check_theme_screenshots_distinct in bin/check.py will fail")
    print("        until you regenerate it).")
