...
body.theme-bauhaus.theme-bauhaus .single-product .single_add_to_cart_button,body.theme-bauhaus.theme-bauhaus .wp-block-button .wp-block-button__link,body.theme-bauhaus.theme-bauhaus .wc-block-cart__submit-container .wc-block-components-checkout-place-order-button{{border-radius:0 !important;border:2px solid var(--wp--preset--color--contrast) !important;background:var(--wp--preset--color--base) !important;color:var(--wp--preset--color--contrast) !important;font-family:var(--wp--preset--font-family--display) !important;font-weight:var(--wp--custom--font-weight--bold,700) !important;letter-spacing:var(--wp--custom--letter-spacing--normal,0) !important;text-transform:uppercase !important;padding:var(--wp--preset--spacing--2-xs) var(--wp--preset--spacing--sm) !important;}}
...
body.theme-lab-decant.theme-lab-decant .single-product .single_add_to_cart_button,body.theme-lab-decant.theme-lab-decant .wp-block-button .wp-block-button__link,body.theme-lab-decant.theme-lab-decant .wc-block-cart__submit-container .wc-block-components-checkout-place-order-button{{border-radius:0 !important;border:1px solid var(--wp--preset--color--contrast) !important;background:var(--wp--preset--color--surface) !important;color:var(--wp--preset--color--contrast) !important;font-family:var(--wp--preset--font-family--display) !important;font-weight:var(--wp--custom--font-weight--bold,700) !important;letter-spacing:var(--wp--custom--letter-spacing--wide,0.1em) !important;text-transform:uppercase !important;padding:var(--wp--preset--spacing--sm) var(--wp--preset--spacing--lg) !important;}}
body.theme-lab-decant.theme-lab-decant .single-product .single_add_to_cart_button:hover,body.theme-lab-decant.theme-lab-decant .wp-block-button .wp-block-button__link:hover,body.theme-lab-decant.theme-lab-decant .wc-block-cart__submit-container .wc-block-components-checkout-place-order-button:hover{{background:var(--wp--preset--color--contrast) !important;color:var(--wp--preset--color--base) !important;}}
body.theme-lab-decant.theme-lab-decant .onsale,body.theme-lab-decant.theme-lab-decant .wc-block-product-collection .wc-block-components-product-sale-badge,body.theme-lab-decant.theme-lab-decant .wc-block-grid__product-onsale{{position:absolute;top:var(--wp--preset--spacing--sm);left:var(--wp--preset--spacing--sm);z-index:2;border-radius:0;background:var(--wp--preset--color--accent-soft);color:var(--wp--preset--color--contrast);font-family:var(--wp--preset--font-family--mono);font-weight:var(--wp--custom--font-weight--semibold,600);font-size:var(--wp--preset--font-size--xs);letter-spacing:var(--wp--custom--letter-spacing--wider,0.08em);text-transform:uppercase;padding:var(--wp--preset--spacing--2-xs) var(--wp--preset--spacing--xs);border:1px dashed var(--wp--preset--color--accent);}}
body.theme-lab-decant.theme-lab-decant .wc-block-breadcrumbs .woocommerce-breadcrumb,body.theme-lab-decant.theme-lab-decant nav.woocommerce-breadcrumb{{font-family:var(--wp--preset--font-family--mono);font-size:var(--wp--preset--font-size--xs);letter-spacing:var(--wp--custom--letter-spacing--wider,0.08em);text-transform:uppercase;color:var(--wp--preset--color--secondary);}}
body.theme-ferment-co.theme-ferment-co .wc-block-components-order-summary-item .wc-block-components-product-badge.wc-block-components-sale-badge,body.theme-ferment-co.theme-ferment-co .wc-block-components-order-summary .wc-block-components-product-badge.wc-block-components-sale-badge,body.theme-ferment-co.theme-ferment-co .wc-block-components-checkout-order-summary .wc-block-components-product-badge.wc-block-components-sale-badge{{background:var(--wp--preset--color--contrast);color:var(--wp--preset--color--base);border:1px solid var(--wp--preset--color--border);border-radius:var(--wp--custom--radius--pill);padding:var(--wp--preset--spacing--2-xs) var(--wp--preset--spacing--xs);font-size:var(--wp--preset--font-size--xs);letter-spacing:var(--wp--custom--letter-spacing--wider,0.08em);text-transform:uppercase;font-weight:var(--wp--custom--font-weight--semibold,600);}}
body.theme-ferment-co.theme-ferment-co .wc-block-components-product-badge.wc-block-components-sale-badge .wc-block-formatted-money-amount,body.theme-ferment-co.theme-ferment-co .wc-block-components-product-badge.wc-block-components-sale-badge span{{color:inherit;}}
@media (max-width:781px){{body.theme-lab-decant.theme-lab-decant .lab-decant-header .wp-block-group.alignwide,body.theme-lab-decant.theme-lab-decant .lab-decant-header__brand,body.theme-lab-decant.theme-lab-decant .lab-decant-header__utility,body.theme-lab-decant.theme-lab-decant .lab-decant-header__nav{{min-width:0;max-width:100%;}}body.theme-lab-decant.theme-lab-decant .wo-layout-lab-decant .alignwide,body.theme-lab-decant.theme-lab-decant .wo-layout-lab-decant h1{{min-width:0;max-width:100%;overflow-wrap:break-word;}}}}
...
body.theme-lab-decant .wo-payment-icons__icon{{border:1px dashed var(--wp--preset--color--accent);border-radius:0;background:var(--wp--preset--color--surface);}}
...
body.theme-lab-decant .wc-block-cart__sidebar,body.theme-lab-decant .wc-block-checkout__sidebar{{padding:var(--wp--preset--spacing--xl);background:var(--wp--preset--color--surface);border:1px solid var(--wp--preset--color--border);border-top:3px solid var(--wp--preset--color--accent);border-radius:0;display:flex;flex-direction:column;gap:var(--wp--preset--spacing--lg);}}
...
body.theme-stellar-sextant .wc-block-components-notice-banner > .wc-block-components-notice-banner__content .wc-forward{{color:var(--wp--preset--color--base) !important;background-color:var(--wp--preset--color--contrast) !important;border:1px solid var(--wp--preset--color--contrast) !important;opacity:1 !important;}}
