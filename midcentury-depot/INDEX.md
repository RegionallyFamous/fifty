...
- **Slug:** `midcentury-depot/faq-accordion`
- **Title:** FAQ accordion
- **Categories:** midcentury-depot
...
- **Slug:** `midcentury-depot/testimonials`
- **Title:** Customer testimonials
- **Categories:** midcentury-depot, testimonials
...
- **Slug:** `midcentury-depot/value-props`
...
- `subtle` = #ede4d6 (Subtle)
- `muted` = #d9ccba (Muted)
- `border` = #c8b99f (Border)
- `tertiary` = #7a6a54 (Tertiary)
- `secondary` = #5c4f3a (Secondary)
- `contrast` = #1f1a13 (Contrast)
- `primary` = #1f1a13 (Primary)
- `primary-hover` = #3d3322 (Primary Hover)
- `accent` = #c96a28 (Accent)
- `accent-soft` = #f2d4b0 (Accent Soft)
- `success` = #4a7c59 (Success)
- `warning` = #c97b28 (Warning)
- `error` = #b03a2e (Error)
- `info` = #3a6b8a (Info)
