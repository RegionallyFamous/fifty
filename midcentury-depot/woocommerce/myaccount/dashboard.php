<?php
/**
 * My Account dashboard — Midcentury-depot override.
 *
 ...
 * `midcentury_depot_render_account_dashboard` callback registered in
 ...
 * relative path matches: `midcentury-depot/woocommerce/myaccount/dashboard.php`.
 *
