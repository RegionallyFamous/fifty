...
- **Slug:** `butcher/testimonials`
- **Title:** Customer testimonials
- **Categories:** butcher, testimonials
...
- `subtle` = #ffffff (Subtle)
- `muted` = #ffffff (Muted)
- `border` = #bfbfbf (Border)
- `tertiary` = #13100d (Tertiary)
- `secondary` = #191612 (Secondary)
- `contrast` = #1f1b16 (Contrast)
- `primary` = #1f1b16 (Primary)
- `primary-hover` = #4c4945 (Primary Hover)
- `accent` = #4a1a1f (Accent)
- `accent-soft` = #d2c6c7 (Accent Soft)
