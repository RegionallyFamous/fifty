<?php
/**
 * My Account dashboard — Butcher override.
 *
 ...
 * `butcher_render_account_dashboard` callback registered in
 ...
 * relative path matches: `butcher/woocommerce/myaccount/dashboard.php`.
 *
 * @package butcher
 */
