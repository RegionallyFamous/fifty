...
add_filter(
	...
	static function ( $translation, $text, $domain ) {
		...
		static $map = array(
			'Estimated total'                                                               => 'Final sum',
			'Proceed to Checkout'                                                           => 'Move to checkout',
			'Proceed to checkout'                                                           => 'Move to checkout',
			'Lost your password?'                                                           => 'Reset your key',
			'Username or email address'                                                     => 'Account name or email',
			'Username or Email Address'                                                     => 'Account name or email',
			'+ Add apartment, suite, etc.'                                                  => 'Add unit or floor',
			'You are currently checking out as a guest.'                                    => 'You are checking out as a guest.',
			'Showing the single result'                                                     => 'One catalogue item',
			'Default sorting'                                                               => 'Counter choice ce71',
			'No products were found matching your selection.'                               => 'No matching catalogue forms found.',
			'No products in the cart.'                                                      => 'The cart is empty.',
			'Your cart is currently empty!'                                                 => 'The cart is empty.',
			'Your cart is currently empty.'                                                 => 'The cart is empty.',
			'Return to shop'                                                                => 'Back to products',
			'Return To Shop'                                                                => 'Back to products',
			'Have a coupon?'                                                                => 'Have a voucher?',
			'Update cart'                                                                   => 'Update cart',
			'Place order'                                                                   => 'Place the order',
			'Apply coupon'                                                                  => 'Apply voucher',
			'Coupon code'                                                                   => 'Voucher square',
			'Order details'                                                                 => 'Receipt record',
			'Order summary'                                                                 => 'Order summary',
			'Cart subtotal'                                                                 => 'Cart subtotal',
			'Add to cart'                                                                   => 'ADD TO CART',
			'Customer details'                                                              => 'Customer record',
			'Save my name, email, and website in this browser for the next time I comment.' => 'Save these details for my next note.',
			'Be the first to review'                                                        => 'Write the first note',
			'Your review'                                                                   => 'Your note',
			'Your rating'                                                                   => 'Your rating',
			'Submit'                                                                        => 'Send note',
			'Description'                                                                   => 'Catalogue notes',
			'Reviews'                                                                       => 'Notes',
			'Additional information'                                                        => 'Measure sheet',
			'View cart'                                                                     => 'View cart sheet',
			'View Cart'                                                                     => 'View cart sheet',
			'Choose an option'                                                              => 'Choose a form',
			'Clear'                                                                         => 'Clear choice',
			'Login'                                                                         => 'Enter account',
			'Log in'                                                                        => 'Enter account',
			'Log out'                                                                       => 'Leave account',
			'Register'                                                                      => 'Open account',
			'Remember me'                                                                   => 'Remember me',
			'My account'                                                                    => 'Account desk',
			'My Account'                                                                    => 'Account desk',
			'Order received'                                                                => 'Order confirmed',
			'Thank you. Your order has been received.'                                      => 'Thank you. Your order is in the press queue.',
			'You may also like&hellip;'                                                     => 'Related forms',
			'You may also like…'                                                            => 'Related forms',
			'Related products'                                                              => 'Related forms',
		);
