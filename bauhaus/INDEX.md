...
- `base` = #f3e9cc (Base)
- `surface` = #faf5e8 (Surface)
- `subtle` = #eae0c3 (Subtle)
- `muted` = #8d8573 (Muted)
- `border` = #111111 (Border)
- `tertiary` = #5d6b7a (Tertiary)
- `secondary` = #1f5191 (Secondary)
- `contrast` = #111111 (Contrast)
- `primary` = #d62616 (Primary)
- `primary-hover` = #a52115 (Primary Hover)
- `accent` = #d62616 (Accent)
- `accent-soft` = #edbea4 (Accent Soft)
- `success` = #393724 (Success)
- `warning` = #7a4a1a (Warning)
- `error` = #a8251e (Error)
- `info` = #1f4e8a (Info)
- `bauhaus-yellow` = #ebc309 (Bauhaus Yellow)
- `bauhaus-blue` = #1f5191 (Bauhaus Blue)
