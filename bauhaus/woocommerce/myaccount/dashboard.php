<?php
/**
 * My Account dashboard — Bauhaus override.
 *
 ...
 * `bauhaus_render_account_dashboard` callback registered in
 ...
 * relative path matches: `bauhaus/woocommerce/myaccount/dashboard.php`.
 *
 * @package bauhaus
 */
