...
- **Slug:** `stellar-sextant/value-props`
...
- `base` = #0a1020 (Base)
- `surface` = #121a2e (Surface)
- `subtle` = #1a2438 (Subtle)
- `muted` = #3d4f6f (Muted)
- `border` = #5a6d8f (Border)
- `tertiary` = #8fa3c2 (Tertiary)
- `secondary` = #c5d0e3 (Secondary)
- `contrast` = #f6f1e8 (Contrast)
- `primary` = #f6f1e8 (Primary)
- `primary-hover` = #dcd6c8 (Primary Hover)
- `accent` = #d4a437 (Accent)
- `accent-soft` = #2a2412 (Accent Soft)
- `success` = #3d8b6a (Success)
- `warning` = #c98a2e (Warning)
- `error` = #c44c4c (Error)
- `info` = #4a7dbd (Info)
...
- `sm` = clamp(0.5rem, 0.6vw + 0.35rem, 0.75rem)
