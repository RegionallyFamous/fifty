<?php
/**
 * My Account dashboard — Stellar-sextant override.
 *
 ...
 * `stellar_sextant_render_account_dashboard` callback registered in
 ...
 * relative path matches: `stellar-sextant/woocommerce/myaccount/dashboard.php`.
 *
