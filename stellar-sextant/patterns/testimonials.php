 ...
 * Slug: stellar-sextant/testimonials
 * Categories: stellar-sextant, testimonials
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Entries from Fellow Navigators', 'stellar-sextant' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--xl)">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Precisely as described in the manifest. I shall be returning to the chart room.', 'stellar-sextant' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Alex M.', 'stellar-sextant' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'The parcel made port ahead of reckoning, and the wrapping was fit for the chart room wall.', 'stellar-sextant' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Sam P.', 'stellar-sextant' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Twelve months in service and it still reads true — not a mark on it.', 'stellar-sextant' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Jordan K.', 'stellar-sextant' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
