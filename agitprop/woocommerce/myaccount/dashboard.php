<?php
/**
 * My Account dashboard — Agitprop override.
 *
 ...
 * `agitprop_render_account_dashboard` callback registered in
 ...
 * relative path matches: `agitprop/woocommerce/myaccount/dashboard.php`.
 *
 * @package agitprop
 */
