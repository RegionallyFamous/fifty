...
// brutalist split. Brand name is hardcoded ('Chonk') rather than
...
<aside class="wo-account-intro">
	<p class="wo-account-intro__eyebrow"><?php esc_html_e( 'ID', 'chonk' ); ?></p>
	<h2 class="wo-account-intro__title"><?php esc_html_e( 'WELCOME BACK TO CHONK.', 'chonk' ); ?></h2>
	<p class="wo-account-intro__lede"><?php esc_html_e( 'Sign in to scan the order log, follow a parcel, and get out the door faster next time.', 'chonk' ); ?></p>
	<ul class="wo-account-intro__perks">
		<li><?php esc_html_e( 'TAP-TO-REORDER', 'chonk' ); ?></li>
		<li><?php esc_html_e( 'ADDRESSES ON FILE', 'chonk' ); ?></li>
		<li><?php esc_html_e( 'FIRST DIBS ON DROPS', 'chonk' ); ?></li>
	</ul>
</aside>
		<?php
	},
...
<p class="wo-account-help"><?php
	printf(
		...
		esc_html__( "CAN'T GET IN? %s.", 'chonk' ),
		'<a href="' . esc_url( '/contact/' ) . '">' . esc_html__( 'POKE US', 'chonk' ) . '</a>'
	);
?></p>
		<?php
	},
...
if ( ! function_exists( 'chonk_swatches_color_map' ) ) {
	function chonk_swatches_color_map(): array {
		return array(
			'amber'    => '#c98018',
			'clear'    => '#e8e3d8',
			'black'    => '#0a0a0a',
...
if ( ! function_exists( 'chonk_swatches_render_group' ) ) {
	function chonk_swatches_render_group( string $default_html, array $args ): string {
		...
		$colors  = chonk_swatches_color_map();
		$buttons = '';
...
add_filter(
	...
	static function ( $html, $args ) {
		...
		return chonk_swatches_render_group( (string) $html, (array) $args );
	},
	20,
	2
);
...
<div class="wo-empty wo-empty--cart">
	<p class="wo-empty__eyebrow"><?php esc_html_e( 'CART', 'chonk' ); ?></p>
	<h1 class="wo-empty__title"><?php esc_html_e( 'CART: EMPTY.', 'chonk' ); ?></h1>
	<p class="wo-empty__lede"><?php esc_html_e( 'Hit the shop or grab something off the journal.', 'chonk' ); ?></p>
	<p class="wo-empty__ctas">
		<a class="wo-empty__cta wo-empty__cta--primary" href="<?php echo esc_url( '/shop/' ); ?>"><?php esc_html_e( 'BACK TO SHOP', 'chonk' ); ?></a>
		<a class="wo-empty__cta wo-empty__cta--secondary" href="<?php echo esc_url( '/journal/' ); ?>"><?php esc_html_e( 'READ THE JOURNAL', 'chonk' ); ?></a>
	</p>
</div>
		<?php
	},
...
<div class="wo-empty wo-empty--shop">
	<p class="wo-empty__eyebrow"><?php esc_html_e( 'SHOP', 'chonk' ); ?></p>
	<h2 class="wo-empty__title"><?php esc_html_e( 'NOTHING FITS THAT FILTER.', 'chonk' ); ?></h2>
	<p class="wo-empty__lede"><?php esc_html_e( 'Try a different cut, or scan the whole catalogue.', 'chonk' ); ?></p>
	<p class="wo-empty__ctas">
		<a class="wo-empty__cta wo-empty__cta--primary" href="<?php echo esc_url( '/shop/' ); ?>"><?php esc_html_e( 'EVERY PRODUCT', 'chonk' ); ?></a>
		<a class="wo-empty__cta wo-empty__cta--secondary" href="<?php echo esc_url( '/journal/' ); ?>"><?php esc_html_e( 'READ THE JOURNAL', 'chonk' ); ?></a>
	</p>
</div>
				<?php
...
add_action(
	...
	static function (): void {
		...
		$label = esc_js( __( 'PAYMENTS', 'chonk' ) );
		?>
<script>
(function(){
