...
The loud cousin of [Agitprop](https://github.com/RegionallyFamous/Agitprop). Same architecture, different attitude.
...
Want a different palette or shape? Open `theme.json`, change the tokens, save. The framework is identical to Agitprop; only the values are different.
...
git clone https://github.com/RegionallyFamous/Chonk.git chonk
```

Then activate Chonk in *Appearance > Themes*. If WooCommerce is installed, the storefront templates start rendering immediately.
...
Do not edit Chonk directly for a real project. Clone it:

```bash
python3 bin/clone.py acme
```

Copies the theme to `../acme/`, renames every `Chonk`/`chonk` reference inside editable files, and prints next steps. Cross-platform (macOS, Linux, Windows). See `bin/clone.py --help` for options.

Then edit `theme.json` to set the brand. Templates do not need to change.

## Documentation

Long-form docs live in the [Chonk Wiki](https://github.com/RegionallyFamous/Chonk/wiki):

- [Getting Started](https://github.com/RegionallyFamous/Chonk/wiki/Getting-Started) - install, clone, first edit
- [Architecture](https://github.com/RegionallyFamous/Chonk/wiki/Architecture) - the philosophy, the five hard rules
- [Project Structure](https://github.com/RegionallyFamous/Chonk/wiki/Project-Structure) - every file and what it does
- [Design Tokens](https://github.com/RegionallyFamous/Chonk/wiki/Design-Tokens) - the vocabulary of the design system
- [Recipes](https://github.com/RegionallyFamous/Chonk/wiki/Recipes) - 15 step-by-step common tasks
- [Block Reference](https://github.com/RegionallyFamous/Chonk/wiki/Block-Reference) - every block grouped by purpose
- [Templates](https://github.com/RegionallyFamous/Chonk/wiki/Templates) - what each template covers
- [WooCommerce Integration](https://github.com/RegionallyFamous/Chonk/wiki/WooCommerce-Integration) - deep guide to every WC surface
- [Style Variations](https://github.com/RegionallyFamous/Chonk/wiki/Style-Variations) - how to build whole-theme looks
- [Anti-Patterns](https://github.com/RegionallyFamous/Chonk/wiki/Anti-Patterns) - 17 mistakes to avoid
- [Working with LLMs](https://github.com/RegionallyFamous/Chonk/wiki/Working-with-LLMs) - using Claude, ChatGPT, Cursor, etc.
- [Tooling](https://github.com/RegionallyFamous/Chonk/wiki/Tooling) - every script in `bin/` explained
- [Contributing](https://github.com/RegionallyFamous/Chonk/wiki/Contributing) - how to send a PR
- [FAQ](https://github.com/RegionallyFamous/Chonk/wiki/FAQ) - quick answers
...
These are not preferences. They define what Chonk is.
...
If a request requires breaking one, the request needs to change, not the rule. See [Architecture](https://github.com/RegionallyFamous/Chonk/wiki/Architecture) for the full reasoning.
...
The "INDEX.md in sync" check fails if you forget. See [Working with LLMs](https://github.com/RegionallyFamous/Chonk/wiki/Working-with-LLMs) for more.
...
| --- | --- | --- |
| Home | [`chonk/`](https://demo.regionallyfamous.com/chonk/) | [/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/chonk/playground/blueprint.json&url=/) |
| Shop | [`chonk/shop/`](https://demo.regionallyfamous.com/chonk/shop/) | [/shop/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/chonk/playground/blueprint.json&url=/shop/) |
| Single product | [`chonk/product/bottled-morning/`](https://demo.regionallyfamous.com/chonk/product/bottled-morning/) | [/product/bottled-morning/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/chonk/playground/blueprint.json&url=/product/bottled-morning/) |
| Cart (pre-filled) | [`chonk/cart/`](https://demo.regionallyfamous.com/chonk/cart/) | [/cart/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/chonk/playground/blueprint.json&url=/cart/?demo=cart) |
| Checkout | [`chonk/checkout/`](https://demo.regionallyfamous.com/chonk/checkout/) | [/checkout/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/chonk/playground/blueprint.json&url=/checkout/?demo=cart) |
| My Account | [`chonk/my-account/`](https://demo.regionallyfamous.com/chonk/my-account/) | [/my-account/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/chonk/playground/blueprint.json&url=/my-account/) |
| Journal | [`chonk/journal/`](https://demo.regionallyfamous.com/chonk/journal/) | [/journal/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/chonk/playground/blueprint.json&url=/journal/) |
| 404 | [`chonk/404/`](https://demo.regionallyfamous.com/chonk/404/) | [/this-route-does-not-exist/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/chonk/playground/blueprint.json&url=/this-route-does-not-exist/) |
