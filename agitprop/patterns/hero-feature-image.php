 ...
 * Slug: agitprop/hero-feature-image
 * Categories: agitprop, featured
 * Block Types: core/post-content
 * Description: The agitprop-hero__photo image. A single-product still composed in
 *              agitprop's brutalist visual language (heavy black borders + flat
 ...
 * Viewport Width: 1280
 *
 * The image lives at agitprop/playground/images/product-wo-portable-hole.jpg
 ...
 * of agitprop (the new theme's own playground/images/ folder is seeded with
 ...
 */
?>
<!-- wp:image {"sizeSlug":"large","className":"agitprop-hero__photo-img"} -->
<figure class="wp-block-image size-large agitprop-hero__photo-img"><img src="<?php echo esc_url( get_theme_file_uri( 'playground/images/product-wo-portable-hole.jpg' ) ); ?>" alt="<?php esc_attr_e( 'Portable Hole — a flat black disc on a white card with a thick black border, pink "OPEN END SOLD SEPARATELY" tag at the bottom. Agitprop\'s hero featured product.', 'agitprop' ); ?>"/></figure>
<!-- /wp:image -->
