 ...
 *   3. Inside a clone of atomic — the new theme's own playground/images/
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--md)">
				...
				<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/journal"><?php esc_html_e( 'Read the journal', 'atomic' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
