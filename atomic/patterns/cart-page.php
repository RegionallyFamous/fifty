...
<p class="has-text-align-center has-secondary-color has-text-color has-xs-font-size wo-empty__eyebrow" style="text-transform:uppercase;letter-spacing:var(--wp--custom--letter-spacing--wider);margin-bottom:0"><?php esc_html_e( 'Launch pad', 'atomic' ); ?></p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-align-center has-3-xl-font-size wo-empty__title" style="margin-top:0;margin-bottom:0;letter-spacing:var(--wp--custom--letter-spacing--tight)"><?php esc_html_e( 'Your capsule is sitting on the pad.', 'atomic' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","className":"wo-empty__lede","textColor":"secondary"} -->
<p class="has-text-align-center has-secondary-color has-text-color wo-empty__lede"><?php esc_html_e( 'Tour the showroom for a payload, or pick up a signal you left in the mission log.', 'atomic' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/shop/"><?php esc_html_e( 'Tour the showroom', 'atomic' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/journal/"><?php esc_html_e( 'Read the mission log', 'atomic' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
