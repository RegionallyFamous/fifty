...
- `base` = #f5f1e8 (Base)
- `surface` = #fefdfb (Surface)
- `subtle` = #ebe7dd (Subtle)
- `muted` = #d4cfc3 (Muted)
- `border` = #b8b3a7 (Border)
- `tertiary` = #8a8575 (Tertiary)
- `secondary` = #3a3a3a (Secondary)
- `contrast` = #1a1a1a (Contrast)
- `primary` = #5a8f8f (Primary)
- `primary-hover` = #487070 (Primary Hover)
- `accent` = #d4a558 (Accent)
- `accent-soft` = #e8d4b0 (Accent Soft)
