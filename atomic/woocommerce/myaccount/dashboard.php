<?php
/**
 * My Account dashboard — Atomic override.
 *
 ...
 * `atomic_render_account_dashboard` callback registered in
 ...
 * relative path matches: `atomic/woocommerce/myaccount/dashboard.php`.
 *
 * @package atomic
 */
