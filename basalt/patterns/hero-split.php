...
<div class="wp-block-group alignfull has-base-background-color has-background" style="padding-top:var(--wp--preset--spacing--3-xl);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--3-xl);padding-left:var(--wp--preset--spacing--md)">
	...
	<div class="wp-block-group alignwide foundry-hero-card has-border-color has-surface-background-color has-background" style="border-color:var(--wp--preset--color--border);border-style:double;border-width:4px;border-radius:2px;padding-top:var(--wp--preset--spacing--3-xl);padding-right:var(--wp--preset--spacing--2-xl);padding-bottom:var(--wp--preset--spacing--3-xl);padding-left:var(--wp--preset--spacing--2-xl)">
		...
		<p class="has-text-align-center has-tertiary-color has-text-color has-xs-font-size" style="font-weight:500;letter-spacing:var(--wp--custom--letter-spacing--engraved);text-transform:uppercase"><?php esc_html_e( 'Kilnyard 7 · Est. 2024', 'foundry' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<p class="has-text-align-center has-accent-color has-text-color has-xl-font-size has-display-font-family" style="margin-top:var(--wp--preset--spacing--sm);margin-bottom:0;line-height:1">— · —</p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="/shop"><?php esc_html_e( 'Open catalog', 'foundry' ); ?></a></div>
			<!-- /wp:button -->

			<!-- wp:button {"className":"is-style-outline"} -->
			<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/journal"><?php esc_html_e( 'Studio notes', 'foundry' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
