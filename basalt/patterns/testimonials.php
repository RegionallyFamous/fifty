...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'From the record', 'foundry' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--xl)">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'As described. I will order from the studio again.', 'foundry' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Alex M.', 'foundry' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Arrived on the third day. Heavier than the photo suggested. Good weight in the hand.', 'foundry' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Sam P.', 'foundry' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'A year in the kitchen. No chips. The glaze has settled into the surface.', 'foundry' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Jordan K.', 'foundry' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
