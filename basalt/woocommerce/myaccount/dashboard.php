<?php
/**
 * My Account dashboard — Foundry override.
 *
 ...
 * `foundry_render_account_dashboard` callback registered in
 ...
 * relative path matches: `foundry/woocommerce/myaccount/dashboard.php`.
 *
 * @package foundry
 */
