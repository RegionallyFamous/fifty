...
- `subtle` = #e8e8e8 (Subtle)
- `muted` = #9e9e9e (Muted)
- `border` = #d1d1d1 (Border)
- `tertiary` = #6b6b6b (Tertiary)
- `secondary` = #3d3d3d (Secondary)
- `contrast` = #000000 (Contrast)
- `primary` = #1a1a1a (Primary)
- `primary-hover` = #2e2e2e (Primary Hover)
- `accent` = #a0826d (Accent)
- `accent-soft` = #d4c4b8 (Accent Soft)
