...
- `base` = #f2ebd2 (Base)
- `surface` = #fffaec (Surface)
- `subtle` = #d9c8a4 (Subtle)
- `muted` = #c4b08a (Muted)
- `border` = #5c2a14 (Border)
- `tertiary` = #6b4a32 (Tertiary)
- `secondary` = #4d3018 (Secondary)
...
- `xl` = clamp(3rem, 5vw + 1.5rem, 5rem)
- `2-xl` = clamp(4rem, 6vw + 2rem, 6.5rem)
...
- `lg` = none
- `xl` = none
- `inset` = inset 0 -2px 0 var(--wp--preset--color--subtle)
