<?php
/**
 * My Account dashboard — Ferment-co override.
 *
 ...
 * `ferment_co_render_account_dashboard` callback registered in
 ...
 * relative path matches: `ferment-co/woocommerce/myaccount/dashboard.php`.
 *
 * @package ferment-co
 */
