<?php
/**
 * My Account dashboard — Apiary override.
 *
 ...
 * `apiary_render_account_dashboard` callback registered in
 ...
 * relative path matches: `apiary/woocommerce/myaccount/dashboard.php`.
 *
 * @package apiary
 */
