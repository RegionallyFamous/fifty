<?php
/**
 * My Account dashboard — Lysholm override.
 *
 ...
 * `lysholm_render_account_dashboard` callback registered in
 ...
 * relative path matches: `lysholm/woocommerce/myaccount/dashboard.php`.
 *
 * @package lysholm
 */
