...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Notes from the shelf', 'apiary' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--xl)">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'It sits on the counter like it\'s been there years. Nothing else in the kitchen tastes quite like it.', 'apiary' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Marielle H.', 'apiary' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Wrapped in wool and kraft, sealed with a paper-bee sticker. Opening it felt like a small ceremony.', 'apiary' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Pekka O.', 'apiary' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'A jar on toast every morning for a month. The wildflower has a faint clove finish I keep coming back to.', 'apiary' ); ?></p>
					<!-- /wp:paragraph -->
					<cite><?php esc_html_e( 'Rowan L.', 'apiary' ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
