...
- `base` = #f4edd8 (Base)
- `surface` = #ede0c4 (Surface)
- `subtle` = #F2F1EC (Subtle)
- `muted` = #d9ccaa (Muted)
- `border` = #c9b98a (Border)
- `tertiary` = #8c8272 (Tertiary)
- `secondary` = #5c4a30 (Secondary)
- `contrast` = #120a00 (Contrast)
- `primary` = #7b3d1e (Primary)
- `primary-hover` = #3D3D3D (Primary Hover)
- `accent` = #b8741a (Accent)
