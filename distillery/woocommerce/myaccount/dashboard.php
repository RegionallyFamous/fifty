<?php
/**
 * My Account dashboard — Distillery override.
 *
 ...
 * `distillery_render_account_dashboard` callback registered in
 ...
 * relative path matches: `distillery/woocommerce/myaccount/dashboard.php`.
 *
 * @package distillery
 */
