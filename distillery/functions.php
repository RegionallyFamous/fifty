...
add_filter(
	...
	static function ( $translation, $text, $domain ) {
		...
		static $map = array(
			'Estimated total'                                                               => 'Stillroom total',
			'Proceed to Checkout'                                                           => 'Close the tasting sheet',
			'Proceed to checkout'                                                           => 'Close the tasting sheet',
			'Lost your password?'                                                           => 'Forgot the cellar key?',
			'Username or email address'                                                     => 'Stillroom email',
			'Username or Email Address'                                                     => 'Stillroom email',
			'+ Add apartment, suite, etc.'                                                  => '+ Suite or cask note',
			'You are currently checking out as a guest.'                                    => 'Guest pour today? Sign in to pull your saved proofs.',
			'Showing the single result'                                                     => 'One bottle on the shelf',
			'Default sorting'                                                               => 'House arrangement',
			'No products were found matching your selection.'                               => 'No bottles match that filter.',
			'No products in the cart.'                                                      => 'The crate is dry.',
			'Your cart is currently empty!'                                                 => 'The crate is dry.',
			'Your cart is currently empty.'                                                 => 'The crate is dry.',
			'Return to shop'                                                                => 'Back to the stillroom floor',
			'Return To Shop'                                                                => 'Back to the stillroom floor',
			'Have a coupon?'                                                                => 'Proof slip in hand?',
			'Update cart'                                                                   => 'Refresh the crate',
			'Place order'                                                                   => 'Seal the batch',
			'Apply coupon'                                                                  => 'Redeem slip',
			'Coupon code'                                                                   => 'Slip code',
			'Order details'                                                                 => 'Batch particulars',
			'Order summary'                                                                 => 'Tasting sheet',
			'Cart subtotal'                                                                 => 'Running pour',
			'Add to cart'                                                                   => 'Add to crate',
			'Customer details'                                                              => 'Your stillroom card',
			'Save my name, email, and website in this browser for the next time I comment.' => 'Keep my hand for the next note.',
			'Be the first to review'                                                        => 'Be the first to leave a tasting note',
			'Your review'                                                                   => 'Your tasting note',
			'Your rating'                                                                   => 'Your pour score',
			'Submit'                                                                        => 'Post note',
			'Description'                                                                   => 'Label copy',
			'Reviews'                                                                       => 'Tasting notes',
			'Additional information'                                                        => 'Behind the label',
			'View cart'                                                                     => 'Peek in the crate',
			'View Cart'                                                                     => 'Peek in the crate',
			'Choose an option'                                                              => 'Pick a finish',
			'Clear'                                                                         => 'Wipe slate',
			'Login'                                                                         => 'Enter the stillroom',
			'Log in'                                                                        => 'Enter the stillroom',
			'Log out'                                                                       => 'Step out quietly',
			'Register'                                                                      => 'Open a stillroom file',
			'Remember me'                                                                   => 'Keep this bench warm',
			'My account'                                                                    => 'Stillroom desk',
			'My Account'                                                                    => 'Stillroom desk',
			'Order received'                                                                => 'Batch received, with thanks',
			'Thank you. Your order has been received.'                                      => 'Thanks, your batch is logged on the sheet.',
			'You may also like&hellip;'                                                     => 'You may also pour',
			'You may also like…'                                                            => 'You may also pour',
			'Related products'                                                              => 'Poured beside these',
		);
