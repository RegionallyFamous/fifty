...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<h2 class="wp-block-heading has-base-color has-text-color has-3-xl-font-size" style="margin-top:0;margin-bottom:0;font-weight:700;text-transform:uppercase;letter-spacing:var(--wp--custom--letter-spacing--tight)"><?php esc_html_e( 'Pick an aisle.', 'chonk' ); ?></h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"fontSize":"sm","textColor":"base","style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|md"}}}} -->
	<p class="has-base-color has-text-color has-sm-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--md)"><?php esc_html_e( 'Three corners of the floor, plus the full catalog. No tour, no waiting list, no sign-up wall.', 'chonk' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons">
		...
		<!-- wp:button {"backgroundColor":"base","textColor":"contrast","style":{"border":{"radius":"0"},"typography":{"textTransform":"uppercase","letterSpacing":"var(--wp--custom--letter-spacing--wider)","fontWeight":"700"}}} -->
		<div class="wp-block-button"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background wp-element-button" href="/product-category/forbidden-snacks/" style="border-radius:0;font-weight:700;text-transform:uppercase;letter-spacing:var(--wp--custom--letter-spacing--wider)"><?php esc_html_e( 'Forbidden snacks', 'chonk' ); ?></a></div>
		<!-- /wp:button -->

		<!-- wp:button {"backgroundColor":"base","textColor":"contrast","style":{"border":{"radius":"0"},"typography":{"textTransform":"uppercase","letterSpacing":"var(--wp--custom--letter-spacing--wider)","fontWeight":"700"}}} -->
		<div class="wp-block-button"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background wp-element-button" href="/product-category/impossibilities/" style="border-radius:0;font-weight:700;text-transform:uppercase;letter-spacing:var(--wp--custom--letter-spacing--wider)"><?php esc_html_e( 'Impossibilities', 'chonk' ); ?></a></div>
		<!-- /wp:button -->
		...
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-base-color has-text-color wp-element-button" href="/shop/" style="border-radius:0;border-width:var(--wp--custom--border--width--thick);font-weight:700;text-transform:uppercase;letter-spacing:var(--wp--custom--letter-spacing--wider)"><?php esc_html_e( 'Walk the whole floor →', 'chonk' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
