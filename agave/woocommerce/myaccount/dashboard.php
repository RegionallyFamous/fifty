<?php
/**
 * My Account dashboard — Agave override.
 *
 ...
 * `agave_render_account_dashboard` callback registered in
 ...
 * relative path matches: `agave/woocommerce/myaccount/dashboard.php`.
 *
 * @package agave
 */
