 ...
 * Slug: agave/account-cta
 * Categories: agave, call-to-action
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<h2 class="wp-block-heading has-text-align-center has-base-color has-text-color" style="margin-top:0;margin-bottom:0"><?php esc_html_e( 'Follow your parcels.', 'agave' ); ?></h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","textColor":"base","style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|md"}}}} -->
	<p class="has-text-align-center has-base-color has-text-color" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--md)"><?php esc_html_e( 'A short ledger of past collections, addresses on file, and saved specimens all sit behind one passphrase. Already a keeper? Pick up where you left off.', 'agave' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background wp-element-button" href="/my-account/" style="border-radius:0"><?php esc_html_e( 'Sign in', 'agave' ); ?></a></div>
		<!-- /wp:button -->

		<!-- wp:button {"textColor":"base","className":"is-style-outline","style":{"border":{"radius":"0"}}} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-base-color has-text-color wp-element-button" href="/my-account/" style="border-radius:0"><?php esc_html_e( 'Start your ledger', 'agave' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
