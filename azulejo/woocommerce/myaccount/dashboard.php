<?php
/**
 * My Account dashboard — Azulejo override.
 *
 ...
 * `azulejo_render_account_dashboard` callback registered in
 ...
 * relative path matches: `azulejo/woocommerce/myaccount/dashboard.php`.
 *
 * @package azulejo
 */
