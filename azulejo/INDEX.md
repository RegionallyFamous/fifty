...
- `subtle` = #eae4d6 (Subtle)
- `muted` = #c8bfa8 (Muted)
- `border` = #d4cdb8 (Border)
- `tertiary` = #8b7355 (Tertiary)
- `secondary` = #1e3a8a (Secondary)
- `contrast` = #0f172a (Contrast)
- `primary` = #1e40af (Primary)
- `primary-hover` = #1e3a8a (Primary Hover)
- `accent` = #ca8a04 (Accent)
- `accent-soft` = #fef3c7 (Accent Soft)
