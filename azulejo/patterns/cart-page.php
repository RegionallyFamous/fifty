...
<p class="has-text-align-center has-secondary-color has-text-color has-xs-font-size wo-empty__eyebrow" style="text-transform:uppercase;letter-spacing:var(--wp--custom--letter-spacing--wider);margin-bottom:0"><?php esc_html_e( 'Reserved patterns', 'azulejo' ); ?></p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-align-center has-3-xl-font-size wo-empty__title" style="margin-top:0;margin-bottom:0;letter-spacing:var(--wp--custom--letter-spacing--tight)"><?php esc_html_e( 'Nothing has been set aside just yet.', 'azulejo' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","className":"wo-empty__lede","textColor":"secondary"} -->
<p class="has-text-align-center has-secondary-color has-text-color wo-empty__lede"><?php esc_html_e( 'Step back into the oficina and choose a pattern to reserve, or linger with a note from the firing log while the kiln cools.', 'azulejo' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/shop/"><?php esc_html_e( 'Return to the oficina', 'azulejo' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/journal/"><?php esc_html_e( 'Read from the firing log', 'azulejo' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
