...
<div class="wp-block-cover alignfull is-light has-custom-content-position is-position-bottom-left" style="padding-top:var(--wp--preset--spacing--3-xl);padding-right:var(--wp--preset--spacing--2-xl);padding-bottom:var(--wp--preset--spacing--3-xl);padding-left:var(--wp--preset--spacing--2-xl);min-height:720px"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'playground/images/cat-moods-feelings.jpg' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-40 has-background-dim"></span>
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group">
			...
			<p class="has-base-color has-text-color has-xs-font-size" style="letter-spacing:var(--wp--custom--letter-spacing--widest);text-transform:uppercase"><?php esc_html_e( 'Oficina no. III · firing of 2026', 'azulejo' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<h1 class="wp-block-heading has-base-color has-text-color" style="margin-top:var(--wp--preset--spacing--md);margin-bottom:var(--wp--preset--spacing--lg);font-size:var(--wp--preset--font-size--6xl);font-weight:var(--wp--custom--font-weight--thin);line-height:1.05"><?php esc_html_e( 'One tile at a time, one month at a time.', 'azulejo' ); ?></h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"fontSize":"md","textColor":"base","style":{"typography":{"lineHeight":"var(--wp--custom--line-height--relaxed)"}}} -->
			<p class="has-base-color has-text-color has-md-font-size" style="line-height:var(--wp--custom--line-height--relaxed)"><?php esc_html_e( 'A gathering of patterns fired in the current season: cobalt scrollwork, gold-ochre frisos, and the occasional manganese purple drawn from a 1780 Lisbon placard.', 'azulejo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
