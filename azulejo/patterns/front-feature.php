...
<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center" style="grid-template-columns:58% auto"><figure class="wp-block-media-text__media"><img src="<?php echo esc_url( get_theme_file_uri( 'playground/images/product-wo-bottled-morning.jpg' ) ); ?>" alt="<?php echo esc_attr__( 'A single hand-painted Portuguese azulejo, cobalt compass-star on a cream tin glaze, photographed flat on the oficina marble.', 'azulejo' ); ?>"/></figure>
	<div class="wp-block-media-text__content">
		...
		<p class="has-tertiary-color has-text-color has-xs-font-size" style="letter-spacing:var(--wp--custom--letter-spacing--widest);text-transform:uppercase"><?php esc_html_e( 'Pattern of the week', 'azulejo' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<h2 class="wp-block-heading has-3-xl-font-size" style="margin-top:var(--wp--preset--spacing--sm);margin-bottom:var(--wp--preset--spacing--md);font-weight:var(--wp--custom--font-weight--thin)"><?php esc_html_e( 'Pattern no. I — Compass-Star', 'azulejo' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"fontSize":"base","textColor":"secondary","style":{"typography":{"lineHeight":"var(--wp--custom--line-height--relaxed)"}}} -->
		<p class="has-secondary-color has-text-color has-base-font-size" style="line-height:var(--wp--custom--line-height--relaxed)"><?php esc_html_e( 'A cobalt-on-cream azulejo painted in oficina no. III, signed in ochre on the reverse by the pintora, and fired in the wood-burning kiln on a quiet Tuesday in 2026. One pattern a week, drawn from the grandmother’s sketchbook.', 'azulejo' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--lg)">
			...
			<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/product/bottled-morning/"><?php esc_html_e( 'See this pattern in full', 'azulejo' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
