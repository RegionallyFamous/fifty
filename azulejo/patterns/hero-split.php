 ...
 *   3. Inside a clone of obel/lysholm — the new theme's own playground/images/
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--3-xl);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--3-xl);padding-left:var(--wp--preset--spacing--md)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<h1 class="wp-block-heading has-5-xl-font-size"><?php esc_html_e( 'Patterns, painted slowly, kept for centuries.', 'azulejo' ); ?></h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"fontSize":"md","textColor":"secondary"} -->
			<p class="has-secondary-color has-text-color has-md-font-size"><?php esc_html_e( 'A Lisbon oficina of hand-painted azulejaria — each tile drawn, cut, glazed, fired and signed on the reverse in an atelier that has worked the same marble tables since 1962.', 'azulejo' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--md)">
				<!-- wp:button -->
				<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/shop"><?php esc_html_e( 'Walk through the patterns', 'azulejo' ); ?></a></div>
				<!-- /wp:button -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_theme_file_uri( 'playground/images/product-wo-bottled-morning.jpg' ) ); ?>" alt="<?php esc_attr_e( 'A hand-painted cobalt-on-cream azulejo photographed against the oficina wall. The signature pattern of the current firing, signed in ochre on the reverse.', 'azulejo' ); ?>"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
	</div>
