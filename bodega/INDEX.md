...
- `subtle` = #f9f5f0 (Subtle)
- `muted` = #fcfaf8 (Muted)
- `border` = #b8b3ac (Border)
...
- `accent` = #c8281a (Accent)
- `accent-soft` = #ecb4af (Accent Soft)
