<?php
/**
 * My Account dashboard — Bodega override.
 *
 ...
 * `bodega_render_account_dashboard` callback registered in
 ...
 * relative path matches: `bodega/woocommerce/myaccount/dashboard.php`.
 *
 * @package bodega
 */
