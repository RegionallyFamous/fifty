<?php
/**
 * Title: Batik counter f39cc7 grid
 * Slug: batik/featured-products
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--2-xl);padding-bottom:var(--wp--preset--spacing--2-xl)">
	...
	<div class="wp-block-group">
		...
		<p class="has-text-align-center has-tertiary-color has-text-color has-xs-font-size" style="letter-spacing:var(--wp--custom--letter-spacing--wider);text-transform:uppercase"><?php esc_html_e( 'Featured', 'batik' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:heading {"textAlign":"center","level":2} -->
		<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Batik counter 0d56fc', 'batik' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
