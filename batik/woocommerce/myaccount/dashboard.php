<?php
/**
 * My Account dashboard — Batik override.
 *
 ...
 * `batik_render_account_dashboard` callback registered in
 ...
 * relative path matches: `batik/woocommerce/myaccount/dashboard.php`.
 *
 * @package batik
 */
