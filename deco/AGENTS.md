...
> Deco is one theme inside the **Fifty monorepo**. The monorepo lives one directory up; its `AGENTS.md` (`../AGENTS.md`) and `README.md` (`../README.md`) describe the layout and the rules that apply to every theme. Read this file for Deco-specific rules. Tooling lives in `../bin/`.

Instructions for AI coding agents working on the Deco theme. Read this file in full before making any changes. Human-oriented docs live in `README.md` and the [project wiki](https://github.com/RegionallyFamous/Fifty/wiki).
...
| `python3 ../bin/clone.py NEW_NAME` | Clone Deco into a new theme folder, renaming all identifiers. |
...
Deco is a block-only WooCommerce starter theme for WordPress. It is intended to be copied (use `python3 ../bin/clone.py NEW_NAME`) and then customized by editing `theme.json` and adding project-specific patterns. The framework itself is deliberately small.
...
| Long-form docs for humans | The [project wiki](https://github.com/RegionallyFamous/Deco/wiki). Do not commit Markdown docs into the repo (other than `README.md`, `INDEX.md`, `SYSTEM-PROMPT.md`, `AGENTS.md`, `CHANGELOG.md`). |
...
4. Set `Categories: deco-store` for project-style patterns or another registered category.
...
### Cloning Deco for a new project
...
For deeper reference, point the user (or read directly via `WebFetch` if you can) at the [project wiki](https://github.com/RegionallyFamous/Deco/wiki):

| Topic | Wiki page |
|---|---|
| Project structure (every file, what it does) | [Project-Structure](https://github.com/RegionallyFamous/Deco/wiki/Project-Structure) |
| Design tokens (which slug to use when) | [Design-Tokens](https://github.com/RegionallyFamous/Deco/wiki/Design-Tokens) |
| Step-by-step recipes for common tasks | [Recipes](https://github.com/RegionallyFamous/Deco/wiki/Recipes) |
| Bad-code/good-code pairs | [Anti-Patterns](https://github.com/RegionallyFamous/Deco/wiki/Anti-Patterns) |
| Inventory of every block referenced | [Block-Reference](https://github.com/RegionallyFamous/Deco/wiki/Block-Reference) |
| WooCommerce template guide | [WooCommerce-Integration](https://github.com/RegionallyFamous/Deco/wiki/WooCommerce-Integration) |
| Architecture and philosophy | [Architecture](https://github.com/RegionallyFamous/Deco/wiki/Architecture) |
| Style variation guide | [Style-Variations](https://github.com/RegionallyFamous/Deco/wiki/Style-Variations) |
| Tooling reference | [Tooling](https://github.com/RegionallyFamous/Deco/wiki/Tooling) |
...
4. For task-specific guidance, browse the [project wiki](https://github.com/RegionallyFamous/Deco/wiki).
...
If the task is "build a new visual variant of this theme" (Deco-style flow), read `../.claude/skills/build-block-theme-variant/SKILL.md` first — it codifies the entire workflow.
