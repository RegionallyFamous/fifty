 ...
 * Slug: deco/hero-feature-image
 * Categories: deco, featured
 * Block Types: core/post-content
 * Description: The deco-hero__photo image. A single-product still composed in
 *              deco's brutalist visual language (heavy black borders + flat
 ...
 * Viewport Width: 1280
 *
 * The image lives at deco/playground/images/product-wo-portable-hole.jpg
 ...
 * of deco (the new theme's own playground/images/ folder is seeded with
 ...
 */
?>
<!-- wp:image {"sizeSlug":"large","className":"deco-hero__photo-img"} -->
<figure class="wp-block-image size-large deco-hero__photo-img"><img src="<?php echo esc_url( get_theme_file_uri( 'playground/images/product-wo-portable-hole.jpg' ) ); ?>" alt="<?php esc_attr_e( 'Portable Hole — a flat black disc on a white card with a thick black border, pink "OPEN END SOLD SEPARATELY" tag at the bottom. Deco\'s hero featured product.', 'deco' ); ?>"/></figure>
<!-- /wp:image -->
