<?php
/**
 * My Account dashboard — Xerox override.
 *
 ...
 * `xerox_render_account_dashboard` callback registered in
 ...
 * relative path matches: `xerox/woocommerce/myaccount/dashboard.php`.
 *
 * @package xerox
 */
