...
add_filter(
	...
	static function ( $translation, $text, $domain ) {
		...
		static $map = array(
			...
			'Username or email address'                                                     => 'Handle or email',
			'Username or Email Address'                                                     => 'Handle or email',
			'+ Add apartment, suite, etc.'                                                  => 'Add apartment, stairwell, secret door',
			'You are currently checking out as a guest.'                                    => 'Checking out as a walk-in.',
			'Showing the single result'                                                     => 'One result on the rack',
			...
			'Return to shop'                                                                => 'Back to the racks',
			'Return To Shop'                                                                => 'Back to the racks',
			...
			'Customer details'                                                              => 'Customer file',
			'Save my name, email, and website in this browser for the next time I comment.' => 'Save my details for the next copy run.',
			'Be the first to review'                                                        => 'Counter note 72a7',
			'Your review'                                                                   => 'Counter note dd9a',
			'Your rating'                                                                   => 'Score the evidence',
			'Submit'                                                                        => 'Send it in',
			...
			'Choose an option'                                                              => 'Pick a variant',
			'Clear'                                                                         => 'Wipe selection',
			'Login'                                                                         => 'Sign in',
			'Log in'                                                                        => 'Sign in',
			'Log out'                                                                       => 'Clock out',
			'Register'                                                                      => 'Make an account',
			'Remember me'                                                                   => 'Keep me stamped in',
			'My account'                                                                    => 'My copy desk',
			'My Account'                                                                    => 'My copy desk',
			'Order received'                                                                => 'Parcel record 9776',
			'Thank you. Your order has been received.'                                      => 'Parcel record c246',
			'You may also like&hellip;'                                                     => 'More from the back table',
...
<aside class="wo-account-intro">
	...
	<h2 class="wo-account-intro__title"><?php esc_html_e( 'WELCOME BACK TO THE COPY DESK.', 'xerox' ); ?></h2>
