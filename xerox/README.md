...
git clone https://github.com/RegionallyFamous/Xerox.git xerox
```

Then activate Xerox in *Appearance > Themes*. If WooCommerce is installed, the storefront templates start rendering immediately.
...
Do not edit Xerox directly for a real project. Clone it:

```bash
python3 bin/clone.py acme
```

Copies the theme to `../acme/`, renames every `Xerox`/`xerox` reference inside editable files, and prints next steps. Cross-platform (macOS, Linux, Windows). See `bin/clone.py --help` for options.

Then edit `theme.json` to set the brand. Templates do not need to change.

## Documentation

Long-form docs live in the [Xerox Wiki](https://github.com/RegionallyFamous/Xerox/wiki):

- [Getting Started](https://github.com/RegionallyFamous/Xerox/wiki/Getting-Started) - install, clone, first edit
- [Architecture](https://github.com/RegionallyFamous/Xerox/wiki/Architecture) - the philosophy, the five hard rules
- [Project Structure](https://github.com/RegionallyFamous/Xerox/wiki/Project-Structure) - every file and what it does
- [Design Tokens](https://github.com/RegionallyFamous/Xerox/wiki/Design-Tokens) - the vocabulary of the design system
- [Recipes](https://github.com/RegionallyFamous/Xerox/wiki/Recipes) - 15 step-by-step common tasks
- [Block Reference](https://github.com/RegionallyFamous/Xerox/wiki/Block-Reference) - every block grouped by purpose
- [Templates](https://github.com/RegionallyFamous/Xerox/wiki/Templates) - what each template covers
- [WooCommerce Integration](https://github.com/RegionallyFamous/Xerox/wiki/WooCommerce-Integration) - deep guide to every WC surface
- [Style Variations](https://github.com/RegionallyFamous/Xerox/wiki/Style-Variations) - how to build whole-theme looks
- [Anti-Patterns](https://github.com/RegionallyFamous/Xerox/wiki/Anti-Patterns) - 17 mistakes to avoid
- [Working with LLMs](https://github.com/RegionallyFamous/Xerox/wiki/Working-with-LLMs) - using Claude, ChatGPT, Cursor, etc.
- [Tooling](https://github.com/RegionallyFamous/Xerox/wiki/Tooling) - every script in `bin/` explained
- [Contributing](https://github.com/RegionallyFamous/Xerox/wiki/Contributing) - how to send a PR
- [FAQ](https://github.com/RegionallyFamous/Xerox/wiki/FAQ) - quick answers
...
These are not preferences. They define what Xerox is.
...
If a request requires breaking one, the request needs to change, not the rule. See [Architecture](https://github.com/RegionallyFamous/Xerox/wiki/Architecture) for the full reasoning.
...
The "INDEX.md in sync" check fails if you forget. See [Working with LLMs](https://github.com/RegionallyFamous/Xerox/wiki/Working-with-LLMs) for more.
...
Each link below opens a disposable WordPress + WooCommerce install with Xerox active and the [Wonders & Oddities](https://github.com/RegionallyFamous/wonders-oddities) dataset pre-loaded. Nothing to install locally. Expect 60 to 90 seconds on first boot while the dataset and images download.
...
| --- | --- | --- |
| Home | [`xerox/`](https://demo.regionallyfamous.com/xerox/) | [/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/xerox/playground/blueprint.json&url=/) |
| Shop | [`xerox/shop/`](https://demo.regionallyfamous.com/xerox/shop/) | [/shop/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/xerox/playground/blueprint.json&url=/shop/) |
| Single product | [`xerox/product/bottled-morning/`](https://demo.regionallyfamous.com/xerox/product/bottled-morning/) | [/product/bottled-morning/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/xerox/playground/blueprint.json&url=/product/bottled-morning/) |
| Cart (pre-filled) | [`xerox/cart/`](https://demo.regionallyfamous.com/xerox/cart/) | [/cart/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/xerox/playground/blueprint.json&url=/cart/?demo=cart) |
| Checkout | [`xerox/checkout/`](https://demo.regionallyfamous.com/xerox/checkout/) | [/checkout/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/xerox/playground/blueprint.json&url=/checkout/?demo=cart) |
| My Account | [`xerox/my-account/`](https://demo.regionallyfamous.com/xerox/my-account/) | [/my-account/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/xerox/playground/blueprint.json&url=/my-account/) |
| Journal | [`xerox/journal/`](https://demo.regionallyfamous.com/xerox/journal/) | [/journal/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/xerox/playground/blueprint.json&url=/journal/) |
| 404 | [`xerox/404/`](https://demo.regionallyfamous.com/xerox/404/) | [/this-route-does-not-exist/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/xerox/playground/blueprint.json&url=/this-route-does-not-exist/) |

The blueprint lives at [`xerox/playground/blueprint.json`](playground/blueprint.json).
