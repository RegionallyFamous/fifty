...
- `subtle` = #252525 (Subtle)
- `muted` = #3a3a3a (Muted)
- `border` = #2e2e2e (Border)
- `tertiary` = #5a5a5a (Tertiary)
- `secondary` = #9a9a9a (Secondary)
- `contrast` = #f0e8d8 (Contrast)
- `primary` = #c8102e (Primary)
- `primary-hover` = #a00d24 (Primary Hover)
- `accent` = #c8102e (Accent)
- `accent-soft` = #3d0810 (Accent Soft)
