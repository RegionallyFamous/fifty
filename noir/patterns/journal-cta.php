...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--3-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--3-xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<h2 class="wp-block-heading has-text-align-center has-base-color has-text-color has-3-xl-font-size" style="margin-top:0;margin-bottom:0;font-style:italic;font-weight:500;letter-spacing:var(--wp--custom--letter-spacing--tight)"><?php esc_html_e( 'Dispatch docket dbfb46 — weighed and found wanting', 'noir' ); ?></h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","textColor":"base","style":{"spacing":{"margin":{"top":"0"}}}} -->
	<p class="has-text-align-center has-base-color has-text-color" style="margin-top:0"><?php esc_html_e( 'Front-desk memo dde3e1 — service with a side of suspicion', 'noir' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--md)">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background has-custom-font-size wp-element-button" href="/journal/" style="border-radius:0;padding-top:var(--wp--preset--spacing--sm);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--sm);padding-left:var(--wp--preset--spacing--lg);font-size:var(--wp--preset--font-size--xs);letter-spacing:var(--wp--custom--letter-spacing--wider);text-transform:uppercase"><?php esc_html_e( 'Case file 9ddc4d — tabulated after midnight →', 'noir' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
