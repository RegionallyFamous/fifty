...
- `tertiary` = #1a1a1a (Tertiary)
- `secondary` = #222222 (Secondary)
- `contrast` = #2b2b2b (Contrast)
- `primary` = #2b2b2b (Primary)
- `primary-hover` = #555555 (Primary Hover)
- `accent` = #b65a3c (Accent)
- `accent-soft` = #deb5a7 (Accent Soft)
