<?php
/**
 * My Account dashboard — Ember override.
 *
 ...
 * `ember_render_account_dashboard` callback registered in
 ...
 * relative path matches: `ember/woocommerce/myaccount/dashboard.php`.
 *
 * @package ember
 */
