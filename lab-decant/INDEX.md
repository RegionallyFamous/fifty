...
- `base` = #ffffff (Base)
- `surface` = #f8f8f4 (Surface)
- `subtle` = #e2e2dc (Subtle)
- `muted` = #9a9a94 (Muted)
- `border` = #c4c4bc (Border)
- `tertiary` = #5a5a58 (Tertiary)
- `secondary` = #2a2a28 (Secondary)
- `contrast` = #0f0f12 (Contrast)
- `primary` = #0f0f12 (Primary)
- `primary-hover` = #1a1a22 (Primary Hover)
- `accent` = #1f66b5 (Accent)
- `accent-soft` = #d4e4f5 (Accent Soft)
...
- `2-xs` = clamp(0.25rem, 0.3vw + 0.1rem, 0.3125rem)
- `xs` = clamp(0.375rem, 0.5vw + 0.2rem, 0.5rem)
- `sm` = clamp(0.5rem, 0.6vw + 0.3rem, 0.75rem)
- `md` = clamp(0.75rem, 0.8vw + 0.5rem, 1rem)
- `lg` = clamp(1rem, 1.2vw + 0.6rem, 1.5rem)
- `xl` = clamp(1.5rem, 2vw + 0.75rem, 2.5rem)
- `2-xl` = clamp(2rem, 3vw + 1rem, 3rem)
- `3-xl` = clamp(2.5rem, 4vw + 1.25rem, 4rem)
- `4-xl` = clamp(3rem, 5vw + 1.5rem, 5rem)
- `5-xl` = clamp(3.5rem, 6vw + 1.75rem, 6rem)
...
- `lg` = none
- `xl` = none
- `inset` = inset 0 1px 2px rgba(15,15,18,0.08)
