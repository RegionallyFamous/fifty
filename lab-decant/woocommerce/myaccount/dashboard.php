<?php
/**
 * My Account dashboard — Lab-decant override.
 *
 ...
 * `lab_decant_render_account_dashboard` callback registered in
 ...
 * relative path matches: `lab-decant/woocommerce/myaccount/dashboard.php`.
 *
 * @package lab-decant
 */
