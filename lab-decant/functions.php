...
add_filter(
	...
	static function ( $translation, $text, $domain ) {
		...
		static $map = array(
			'Estimated total'                                                               => 'Register sum f948',
			'Proceed to Checkout'                                                           => 'To the register b037',
			'Proceed to checkout'                                                           => 'To the register 4ad0',
			'Lost your password?'                                                           => 'Key misplaced 9a0a',
			'Username or email address'                                                     => 'Lab Decant register 2c44',
			'Username or Email Address'                                                     => 'Lab Decant register da5f',
			'+ Add apartment, suite, etc.'                                                  => 'Lab Decant register ba09',
			'You are currently checking out as a guest.'                                    => 'Lab Decant register 59d2',
			'Showing the single result'                                                     => 'Lab Decant register 975e',
			'Default sorting'                                                               => 'Counter choice f9df',
			'No products were found matching your selection.'                               => 'Shop-floor find 00c6',
			'No products in the cart.'                                                      => 'Parcel basket 1df9',
			'Your cart is currently empty!'                                                 => 'Parcel basket 647f',
			'Your cart is currently empty.'                                                 => 'Parcel basket 37b4',
			'Return to shop'                                                                => 'Lab Decant register fd56',
			'Return To Shop'                                                                => 'Lab Decant register cf42',
			'Have a coupon?'                                                                => 'Voucher slip 5a40',
			'Update cart'                                                                   => 'Parcel basket e2f3',
			'Place order'                                                                   => 'To the register 2dc3',
			'Apply coupon'                                                                  => 'Voucher slip d1cb',
			'Coupon code'                                                                   => 'Voucher slip 1c0d',
			'Order details'                                                                 => 'Parcel record a66b',
			'Order summary'                                                                 => 'Parcel record 37bc',
			'Cart subtotal'                                                                 => 'Parcel basket 207e',
			'Add to cart'                                                                   => 'Parcel basket b92b',
			'Customer details'                                                              => 'Lab Decant register e6a4',
			'Save my name, email, and website in this browser for the next time I comment.' => 'Lab Decant register 392d',
			'Be the first to review'                                                        => 'Counter note 0afd',
			'Your review'                                                                   => 'Counter note 40fb',
			'Your rating'                                                                   => 'Lab Decant register d49e',
			'Submit'                                                                        => 'Lab Decant register 0d3b',
			'Description'                                                                   => 'Lab Decant register afbf',
			'Reviews'                                                                       => 'Counter note 41a1',
			'Additional information'                                                        => 'Lab Decant register f295',
			'View cart'                                                                     => 'Parcel basket 09f5',
			'View Cart'                                                                     => 'Parcel basket b2b4',
			'Choose an option'                                                              => 'Lab Decant register c989',
			'Clear'                                                                         => 'Lab Decant register c21c',
			'Login'                                                                         => 'Lab Decant register 7f0d',
			'Log in'                                                                        => 'Lab Decant register 0292',
			'Log out'                                                                       => 'Lab Decant register c801',
			'Register'                                                                      => 'Lab Decant register 67ae',
			'Remember me'                                                                   => 'Lab Decant register c5a5',
			'My account'                                                                    => 'Lab Decant register ab9a',
			'My Account'                                                                    => 'Lab Decant register bbc1',
			'Order received'                                                                => 'Parcel record 7c0d',
			'Thank you. Your order has been received.'                                      => 'Parcel record 8f92',
			'You may also like&hellip;'                                                     => 'Lab Decant register c079',
			'You may also like…'                                                            => 'Lab Decant register 9a16',
			'Related products'                                                              => 'Shop-floor find 7cab',
		);
