...
git clone https://github.com/RegionallyFamous/Cog.git cog
```

Then activate Cog in *Appearance > Themes*. If WooCommerce is installed, the storefront templates start rendering immediately.
...
Do not edit Cog directly for a real project. Clone it:

```bash
python3 bin/clone.py acme
```

Copies the theme to `../acme/`, renames every `Cog`/`cog` reference inside editable files, and prints next steps. Cross-platform (macOS, Linux, Windows). See `bin/clone.py --help` for options.

Then edit `theme.json` to set the brand. Templates do not need to change.

## Documentation

Long-form docs live in the [Cog Wiki](https://github.com/RegionallyFamous/Cog/wiki):

- [Getting Started](https://github.com/RegionallyFamous/Cog/wiki/Getting-Started) - install, clone, first edit
- [Architecture](https://github.com/RegionallyFamous/Cog/wiki/Architecture) - the philosophy, the five hard rules
- [Project Structure](https://github.com/RegionallyFamous/Cog/wiki/Project-Structure) - every file and what it does
- [Design Tokens](https://github.com/RegionallyFamous/Cog/wiki/Design-Tokens) - the vocabulary of the design system
- [Recipes](https://github.com/RegionallyFamous/Cog/wiki/Recipes) - 15 step-by-step common tasks
- [Block Reference](https://github.com/RegionallyFamous/Cog/wiki/Block-Reference) - every block grouped by purpose
- [Templates](https://github.com/RegionallyFamous/Cog/wiki/Templates) - what each template covers
- [WooCommerce Integration](https://github.com/RegionallyFamous/Cog/wiki/WooCommerce-Integration) - deep guide to every WC surface
- [Style Variations](https://github.com/RegionallyFamous/Cog/wiki/Style-Variations) - how to build whole-theme looks
- [Anti-Patterns](https://github.com/RegionallyFamous/Cog/wiki/Anti-Patterns) - 17 mistakes to avoid
- [Working with LLMs](https://github.com/RegionallyFamous/Cog/wiki/Working-with-LLMs) - using Claude, ChatGPT, Cursor, etc.
- [Tooling](https://github.com/RegionallyFamous/Cog/wiki/Tooling) - every script in `bin/` explained
- [Contributing](https://github.com/RegionallyFamous/Cog/wiki/Contributing) - how to send a PR
- [FAQ](https://github.com/RegionallyFamous/Cog/wiki/FAQ) - quick answers
...
These are not preferences. They define what Cog is.
...
If a request requires breaking one, the request needs to change, not the rule. See [Architecture](https://github.com/RegionallyFamous/Cog/wiki/Architecture) for the full reasoning.
...
The "INDEX.md in sync" check fails if you forget. See [Working with LLMs](https://github.com/RegionallyFamous/Cog/wiki/Working-with-LLMs) for more.
...
Each link below opens a disposable WordPress + WooCommerce install with Cog active and the [Wonders & Oddities](https://github.com/RegionallyFamous/wonders-oddities) dataset pre-loaded. Nothing to install locally. Expect 60 to 90 seconds on first boot while the dataset and images download.
...
| --- | --- | --- |
| Home | [`cog/`](https://demo.regionallyfamous.com/cog/) | [/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/cog/playground/blueprint.json&url=/) |
| Shop | [`cog/shop/`](https://demo.regionallyfamous.com/cog/shop/) | [/shop/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/cog/playground/blueprint.json&url=/shop/) |
| Single product | [`cog/product/bottled-morning/`](https://demo.regionallyfamous.com/cog/product/bottled-morning/) | [/product/bottled-morning/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/cog/playground/blueprint.json&url=/product/bottled-morning/) |
| Cart (pre-filled) | [`cog/cart/`](https://demo.regionallyfamous.com/cog/cart/) | [/cart/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/cog/playground/blueprint.json&url=/cart/?demo=cart) |
| Checkout | [`cog/checkout/`](https://demo.regionallyfamous.com/cog/checkout/) | [/checkout/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/cog/playground/blueprint.json&url=/checkout/?demo=cart) |
| My Account | [`cog/my-account/`](https://demo.regionallyfamous.com/cog/my-account/) | [/my-account/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/cog/playground/blueprint.json&url=/my-account/) |
| Journal | [`cog/journal/`](https://demo.regionallyfamous.com/cog/journal/) | [/journal/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/cog/playground/blueprint.json&url=/journal/) |
| 404 | [`cog/404/`](https://demo.regionallyfamous.com/cog/404/) | [/this-route-does-not-exist/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/cog/playground/blueprint.json&url=/this-route-does-not-exist/) |

The blueprint lives at [`cog/playground/blueprint.json`](playground/blueprint.json).
