...
git clone https://github.com/RegionallyFamous/Aero.git aero
```

Then activate Aero in *Appearance > Themes*. If WooCommerce is installed, the storefront templates start rendering immediately.
...
Do not edit Aero directly for a real project. Clone it:

```bash
python3 bin/clone.py acme
```

Copies the theme to `../acme/`, renames every `Aero`/`aero` reference inside editable files, and prints next steps. Cross-platform (macOS, Linux, Windows). See `bin/clone.py --help` for options.

Then edit `theme.json` to set the brand. Templates do not need to change.

## Documentation

Long-form docs live in the [Aero Wiki](https://github.com/RegionallyFamous/Aero/wiki):

- [Getting Started](https://github.com/RegionallyFamous/Aero/wiki/Getting-Started) - install, clone, first edit
- [Architecture](https://github.com/RegionallyFamous/Aero/wiki/Architecture) - the philosophy, the five hard rules
- [Project Structure](https://github.com/RegionallyFamous/Aero/wiki/Project-Structure) - every file and what it does
- [Design Tokens](https://github.com/RegionallyFamous/Aero/wiki/Design-Tokens) - the vocabulary of the design system
- [Recipes](https://github.com/RegionallyFamous/Aero/wiki/Recipes) - 15 step-by-step common tasks
- [Block Reference](https://github.com/RegionallyFamous/Aero/wiki/Block-Reference) - every block grouped by purpose
- [Templates](https://github.com/RegionallyFamous/Aero/wiki/Templates) - what each template covers
- [WooCommerce Integration](https://github.com/RegionallyFamous/Aero/wiki/WooCommerce-Integration) - deep guide to every WC surface
- [Style Variations](https://github.com/RegionallyFamous/Aero/wiki/Style-Variations) - how to build whole-theme looks
- [Anti-Patterns](https://github.com/RegionallyFamous/Aero/wiki/Anti-Patterns) - 17 mistakes to avoid
- [Working with LLMs](https://github.com/RegionallyFamous/Aero/wiki/Working-with-LLMs) - using Claude, ChatGPT, Cursor, etc.
- [Tooling](https://github.com/RegionallyFamous/Aero/wiki/Tooling) - every script in `bin/` explained
- [Contributing](https://github.com/RegionallyFamous/Aero/wiki/Contributing) - how to send a PR
- [FAQ](https://github.com/RegionallyFamous/Aero/wiki/FAQ) - quick answers
...
These are not preferences. They define what Aero is.
...
If a request requires breaking one, the request needs to change, not the rule. See [Architecture](https://github.com/RegionallyFamous/Aero/wiki/Architecture) for the full reasoning.
...
The "INDEX.md in sync" check fails if you forget. See [Working with LLMs](https://github.com/RegionallyFamous/Aero/wiki/Working-with-LLMs) for more.
...
Each link below opens a disposable WordPress + WooCommerce install with Aero active and the [Wonders & Oddities](https://github.com/RegionallyFamous/wonders-oddities) dataset pre-loaded. Nothing to install locally. Expect 60 to 90 seconds on first boot while the dataset and images download.
...
| --- | --- | --- |
| Home | [`aero/`](https://demo.regionallyfamous.com/aero/) | [/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/aero/playground/blueprint.json&url=/) |
| Shop | [`aero/shop/`](https://demo.regionallyfamous.com/aero/shop/) | [/shop/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/aero/playground/blueprint.json&url=/shop/) |
| Single product | [`aero/product/bottled-morning/`](https://demo.regionallyfamous.com/aero/product/bottled-morning/) | [/product/bottled-morning/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/aero/playground/blueprint.json&url=/product/bottled-morning/) |
| Cart (pre-filled) | [`aero/cart/`](https://demo.regionallyfamous.com/aero/cart/) | [/cart/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/aero/playground/blueprint.json&url=/cart/?demo=cart) |
| Checkout | [`aero/checkout/`](https://demo.regionallyfamous.com/aero/checkout/) | [/checkout/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/aero/playground/blueprint.json&url=/checkout/?demo=cart) |
| My Account | [`aero/my-account/`](https://demo.regionallyfamous.com/aero/my-account/) | [/my-account/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/aero/playground/blueprint.json&url=/my-account/) |
| Journal | [`aero/journal/`](https://demo.regionallyfamous.com/aero/journal/) | [/journal/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/aero/playground/blueprint.json&url=/journal/) |
| 404 | [`aero/404/`](https://demo.regionallyfamous.com/aero/404/) | [/this-route-does-not-exist/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/aero/playground/blueprint.json&url=/this-route-does-not-exist/) |

The blueprint lives at [`aero/playground/blueprint.json`](playground/blueprint.json).
