...
|-- assets/
|   `-- fonts/
|       |-- chango-regular.woff2
|       |-- quicksand-bold.woff2
|       |-- quicksand-regular.woff2
|       `-- quicksand-semibold.woff2
|-- parts/
...
- `subtle` = #FFEEF7 (Subtle)
- `muted` = #E5DCFF (Muted)
- `border` = #D4C4F2 (Border)
- `tertiary` = #6B5FA8 (Tertiary)
- `secondary` = #4A3F87 (Secondary)
- `contrast` = #2D1F66 (Contrast)
- `primary` = #2D1F66 (Primary)
- `primary-hover` = #1A0F4A (Primary Hover)
- `accent` = #0080A2 (Accent)
- `accent-soft` = #B8F0FF (Accent Soft)
- `iridescent` = #FFD4F0 (Iridescent)
- `chrome` = #C8C4DD (Chrome)
- `success` = #1F8266 (Success)
- `warning` = #C68A2E (Warning)
- `error` = #C8395E (Error)
- `info` = #4A6FE0 (Info)
...
- `xs` = 0 1px 2px rgba(74,63,135,0.10)
- `sm` = 0 2px 6px rgba(74,63,135,0.10), 0 1px 2px rgba(74,63,135,0.08)
- `md` = 0 6px 18px rgba(74,63,135,0.14), 0 2px 6px rgba(74,63,135,0.08)
- `lg` = 0 18px 40px rgba(74,63,135,0.18), 0 6px 14px rgba(74,63,135,0.10)
- `xl` = 0 32px 64px rgba(74,63,135,0.22), 0 10px 24px rgba(74,63,135,0.12)
- `glass` = inset 0 1px 0 rgba(255,255,255,0.7), inset 0 -2px 4px rgba(74,63,135,0.18), 0 8px 18px rgba(0,153,194,0.30)
- `chrome` = inset 0 1px 0 rgba(255,255,255,0.9), inset 0 -2px 6px rgba(74,63,135,0.30), 0 4px 12px rgba(74,63,135,0.20)
- `inset` = inset 0 2px 4px rgba(74,63,135,0.18)
