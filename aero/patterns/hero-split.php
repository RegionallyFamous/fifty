 ...
 *   3. Inside a clone of aero — the new theme's own playground/images/
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--3-xl);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--3-xl);padding-left:var(--wp--preset--spacing--md)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			<!-- wp:paragraph {"fontSize":"xs","textColor":"secondary","style":{"typography":{"letterSpacing":"var(--wp--custom--letter-spacing--widest)","textTransform":"uppercase","fontWeight":"600"},"spacing":{"margin":{"bottom":"var:preset|spacing|md"}}},"fontFamily":"sans"} -->
			<p class="has-secondary-color has-text-color has-xs-font-size has-sans-font-family" style="margin-bottom:var(--wp--preset--spacing--md);font-weight:600;letter-spacing:var(--wp--custom--letter-spacing--widest);text-transform:uppercase">✦ <?php esc_html_e( 'New season · iridescent edit', 'aero' ); ?> ✦</p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"level":1,"fontSize":"5xl"} -->
			<h1 class="wp-block-heading has-5-xl-font-size"><?php esc_html_e( 'Catch the shimmer.', 'aero' ); ?></h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"fontSize":"md","textColor":"secondary"} -->
			<p class="has-secondary-color has-text-color has-md-font-size"><?php esc_html_e( 'Wonders & Oddities for the soft-future kid in everyone. Bubble chrome, holographic pastels, slightly haunted artefacts — wrapped, ribboned, ready to ship.', 'aero' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--md)">
				<!-- wp:button -->
				<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/shop"><?php esc_html_e( 'Browse the collection ✦', 'aero' ); ?></a></div>
				<!-- /wp:button -->

				<!-- wp:button {"className":"is-style-outline"} -->
				<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/journal"><?php esc_html_e( 'Read the journal', 'aero' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<figure class="wp-block-image size-large" style="aspect-ratio:var(--wp--custom--aspect-ratio--widescreen)"><img src="<?php echo esc_url( get_theme_file_uri( 'playground/images/wonders-bottled-morning.png' ) ); ?>" alt="<?php esc_attr_e( 'Bottled Morning — a cork-stoppered glass bottle of warm light, the flagship product of the Wonders &amp; Oddities demo catalogue.', 'aero' ); ?>" /></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
	</div>
